...
Decay_phim = Decay(name = 'Decay_phim',
                   particle = P.phim,
                   partial_widths = {(P.b,P.b__tilde__):'((-12*gSM**2*MB**2*yb**2 + 3*gSM**2*Mphi**2*yb**2)*cmath.sqrt(-4*MB**2*Mphi**2 + Mphi**4))/(16.*cmath.pi*abs(Mphi)**3)/200',
                                     (P.c,P.c__tilde__):'((-12*gSM**2*MC**2*yc**2 + 3*gSM**2*Mphi**2*yc**2)*cmath.sqrt(-4*MC**2*Mphi**2 + Mphi**4))/(16.*cmath.pi*abs(Mphi)**3)/200',
                                     (P.chi,P.chi__tilde__):'((-8*gDM**2*Mchi**2 + 2*gDM**2*Mphi**2)*cmath.sqrt(-4*Mchi**2*Mphi**2 + Mphi**4))/(16.*cmath.pi*abs(Mphi)**3)/200',
                                     (P.d,P.d__tilde__):'((-12*gSM**2*MD**2*ydo**2 + 3*gSM**2*Mphi**2*yd**2)*cmath.sqrt(-4*MD**2*Mphi**2 + Mphi**4))/(16.*cmath.pi*abs(Mphi)**3)/200',
                                     (P.e__minus__,P.e__plus__):'((-4*gSM**2*Me**2*ye**2 + gSM**2*Mphi**2*ye**2)*cmath.sqrt(-4*Me**2*Mphi**2 + Mphi**4))/(16.*cmath.pi*abs(Mphi)**3)',
                                     (P.mu__minus__,P.mu__plus__):'((-4*gSM**2*MMU**2*ym**2 + gSM**2*Mphi**2*ym**2)*cmath.sqrt(-4*MMU**2*Mphi**2 + Mphi**4))/(16.*cmath.pi*abs(Mphi)**3)',
                                     (P.s,P.s__tilde__):'((3*gSM**2*Mphi**2*ys**2 - 12*gSM**2*MS**2*ys**2)*cmath.sqrt(Mphi**4 - 4*Mphi**2*MS**2))/(16.*cmath.pi*abs(Mphi)**3)',
                                     (P.t,P.t__tilde__):'((3*gSM**2*Mphi**2*yt**2 - 12*gSM**2*MT**2*yt**2)*cmath.sqrt(Mphi**4 - 4*Mphi**2*MT**2))/(16.*cmath.pi*abs(Mphi)**3)/200',
                                     (P.ta__minus__,P.ta__plus__):'((gSM**2*Mphi**2*ytau**2 - 4*gSM**2*MTA**2*ytau**2)*cmath.sqrt(Mphi**4 - 4*Mphi**2*MTA**2))/(16.*cmath.pi*abs(Mphi)**3)',
                                     (P.u,P.u__tilde__):'((3*gSM**2*Mphi**2*yup**2 - 12*gSM**2*MU**2*yup**2)*cmath.sqrt(Mphi**4 - 4*Mphi**2*MU**2))/(16.*cmath.pi*abs(Mphi)**3)/200'})
