...
########################################################
#
# pseudoscalar couplings of mediator to DM & fermions
#
########################################################
GC_PSEUDO_E = Coupling(name = 'GC_PSEUDO_E',
                 value = '(gqq*ye)/cmath.sqrt(2)',
                 order = {'NP':1})
GC_PSEUDO_MU = Coupling(name = 'GC_PSEUDO_MU',
                 value = '(gqq*ymu)/cmath.sqrt(2)',
                 order = {'NP':1})
GC_PSEUDO_TAU = Coupling(name = 'GC_PSEUDO_TAU',
                 value = '(gqq*ytau)/cmath.sqrt(2)',
                 order = {'NP':1})
GC_PSEUDO_U = Coupling(name = 'GC_PSEUDO_U',
                 value = '(gqq*yu)/cmath.sqrt(2)',
                 order = {'NP':1})
GC_PSEUDO_C = Coupling(name = 'GC_PSEUDO_C',
                 value = '(gqq*yc)/cmath.sqrt(2)',
                 order = {'NP':1})
GC_PSEUDO_T = Coupling(name = 'GC_PSEUDO_T',
                 value = '(gqq*yt)/cmath.sqrt(2)',
                 order = {'NP':1})
GC_PSEUDO_D = Coupling(name = 'GC_PSEUDO_D',
                 value = '(gqq*yd)/cmath.sqrt(2)',
                 order = {'NP':1})
GC_PSEUDO_S = Coupling(name = 'GC_PSEUDO_S',
                 value = '(gqq*ys)/cmath.sqrt(2)',
                 order = {'NP':1})
GC_PSEUDO_B = Coupling(name = 'GC_PSEUDO_B',
                 value = '(gqq*yb)/cmath.sqrt(2)',
                 order = {'NP':1})
GC_PSEUDO_DM = Coupling(name = 'GC_PSEUDO_DM',
