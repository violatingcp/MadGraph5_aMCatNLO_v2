...
################################################################
#
#  pseudoscalar mediator interactions with DM and fermions
#
################################################################
...
V_154 = Vertex(name = 'V_154',
               ...
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS6 ],
               couplings = {(0,0):C.GC_PSEUDO_U})

V_155 = Vertex(name = 'V_155',
               particles = [ P.c__tilde__, P.c, P.phim ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS6 ],
               couplings = {(0,0):C.GC_PSEUDO_C})

V_156 = Vertex(name = 'V_156',
               particles = [ P.t__tilde__, P.t, P.phim ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS6 ],
               couplings = {(0,0):C.GC_PSEUDO_T})

V_157 = Vertex(name = 'V_157',
               particles = [ P.d__tilde__, P.d, P.phim ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS6 ],
               couplings = {(0,0):C.GC_PSEUDO_D})

V_158 = Vertex(name = 'V_158',
               particles = [ P.s__tilde__, P.s, P.phim ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS6 ],
               couplings = {(0,0):C.GC_PSEUDO_S})

V_159 = Vertex(name = 'V_159',
               particles = [ P.b__tilde__, P.b, P.phim ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS6 ],
               couplings = {(0,0):C.GC_PSEUDO_B})

V_160 = Vertex(name = 'V_160',
               particles = [ P.chi, P.chi__tilde__, P.phim],
               color = [ '1' ],
               lorentz = [ L.FFS6 ],
               couplings = {(0,0):C.GC_PSEUDO_DM})
