...
########################################################
#
# scalar couplings of mediator to DM & fermions
#
########################################################
GC_SCALAR_E = Coupling(name = 'GC_SCALAR_E',
                 value = '-((complex(0,1)*gqq*ye)/cmath.sqrt(2))',
                 order = {'NP':1})
GC_SCALAR_MU = Coupling(name = 'GC_SCALAR_MU',
                 value = '-((complex(0,1)*gqq*ymu)/cmath.sqrt(2))',
                 order = {'NP':1})
GC_SCALAR_TAU = Coupling(name = 'GC_SCALAR_TAU',
                 value = '-((complex(0,1)*gqq*ytau)/cmath.sqrt(2))',
                 order = {'NP':1})
GC_SCALAR_U = Coupling(name = 'GC_SCALAR_U',
                 value = '-((complex(0,1)*gqq*yu)/cmath.sqrt(2))',
                 order = {'NP':1})
GC_SCALAR_C = Coupling(name = 'GC_SCALAR_C',
                 value = '-((complex(0,1)*gqq*yc)/cmath.sqrt(2))',
                 order = {'NP':1})
GC_SCALAR_T = Coupling(name = 'GC_SCALAR_T',
                 value = '-((complex(0,1)*gqq*yt)/cmath.sqrt(2))',
                 order = {'NP':1})
GC_SCALAR_D = Coupling(name = 'GC_SCALAR_D',
                 value = '-((complex(0,1)*gqq*yd)/cmath.sqrt(2))',
                 order = {'NP':1})
GC_SCALAR_S = Coupling(name = 'GC_SCALAR_S',
                 value = '-((complex(0,1)*gqq*ys)/cmath.sqrt(2))',
                 order = {'NP':1})
GC_SCALAR_B = Coupling(name = 'GC_SCALAR_B',
                 value = '-((complex(0,1)*gqq*yb)/cmath.sqrt(2))',
                 order = {'NP':1})
GC_SCALAR_DM = Coupling(name = 'GC_SCALAR_DM',
