...
aparser.add_argument('-med'     ,'--medrange'  ,dest='medrange',nargs='+',type=int,     default=[10,20,50,100,200,300,500,1000,2000,5000,10000],help='mediator range')
...
aparser.add_argument('-install' ,'--install'   ,type=bool      ,dest='install' ,default=False,help='install MG')
...
for med    in args1.medrange:
    for dm in args1.dmrange:
        if med < dm and med != 10:
            continue
        tmpMed = med
        if med == 2*dm:
            tmpMed = 2*dm - 5
        #if tmpMed != med or med == 10:
        #    continue
